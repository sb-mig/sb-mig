...
export const migrateDescription = `
    ...
    FLAGS
        ...
        --preservePublishedLayer - Opt-in dual-layer mode for dirty published stories. Migrates latest published Story Version first, publishes it, then restores migrated draft with publish:false. Requires --publish and migrate-from space. [content only]
    ...
    EXAMPLES
        ...
        $ sb-mig migrate content --all --from 12345 --to 12345 --migration file-with-migration --publish --preservePublishedLayer --dry-run
