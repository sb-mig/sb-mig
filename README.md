...
_See code: [src/commands/backup.ts](https://github.com/sb-mig/sb-mig/blob/v2.1.8/src/commands/backup.ts)_
...
_See code: [src/commands/debug.ts](https://github.com/sb-mig/sb-mig/blob/v2.1.8/src/commands/debug.ts)_
...
_See code: [src/commands/sync.ts](https://github.com/sb-mig/sb-mig/blob/v2.1.8/src/commands/sync.ts)_
<!-- commandsstop -->
