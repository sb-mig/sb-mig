...
@sb-mig/plugin-generate-project/0.1.2 darwin-x64 node-v12.16.2
$ sb-mig --help [COMMAND]
USAGE
  $ sb-mig COMMAND
...
...
_See code: [src/commands/generate.ts](https://github.com/sb-mig/plugin-generate-project/blob/v0.1.2/src/commands/generate.ts)_
<!-- commandsstop -->
