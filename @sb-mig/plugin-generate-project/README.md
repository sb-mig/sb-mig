...
@sb-mig/plugin-generate-project/0.4.5 linux-x64 node-v12.19.0
$ sb-mig --help [COMMAND]
USAGE
  $ sb-mig COMMAND
...
...
_See code: [src/commands/generate.ts](https://github.com/sb-mig/plugin-generate-project/blob/v0.4.5/src/commands/generate.ts)_
<!-- commandsstop -->
