...
@sb-mig/plugin-generate-project/0.3.2 linux-x64 node-v12.18.4
$ sb-mig --help [COMMAND]
USAGE
  $ sb-mig COMMAND
...
...
_See code: [src/commands/generate.ts](https://github.com/sb-mig/plugin-generate-project/blob/v0.3.2/src/commands/generate.ts)_
<!-- commandsstop -->
