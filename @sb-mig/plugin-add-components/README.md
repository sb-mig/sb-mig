...
@sb-mig/plugin-add-components/0.5.12 linux-x64 node-v12.22.6
$ sb-mig --help [COMMAND]
USAGE
  $ sb-mig COMMAND
...
...
_See code: [lib/commands/add.js](https://github.com/sb-mig/sb-mig/blob/v0.5.12/lib/commands/add.js)_
<!-- commandsstop -->
