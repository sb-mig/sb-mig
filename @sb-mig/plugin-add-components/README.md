...
@sb-mig/plugin-add-components/0.1.4 darwin-x64 node-v12.16.2
$ sb-mig --help [COMMAND]
USAGE
  $ sb-mig COMMAND
...
...
_See code: [src/commands/add.ts](https://github.com/sb-mig/plugin-add-components/blob/v0.1.4/src/commands/add.ts)_
<!-- commandsstop -->
