...
@sb-mig/plugin-create-component/0.0.10 darwin-x64 node-v12.16.2
$ sb-mig --help [COMMAND]
USAGE
  $ sb-mig COMMAND
...
...
_See code: [src/commands/create.ts](https://github.com/sb-mig/plugin-create-component/blob/v0.0.10/src/commands/create.ts)_
<!-- commandsstop -->
