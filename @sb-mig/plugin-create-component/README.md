...
@sb-mig/plugin-create-component/0.1.6 linux-x64 node-v12.19.0
$ sb-mig --help [COMMAND]
USAGE
  $ sb-mig COMMAND
...
...
_See code: [src/commands/create.ts](https://github.com/sb-mig/plugin-create-component/blob/v0.1.6/src/commands/create.ts)_
<!-- commandsstop -->
