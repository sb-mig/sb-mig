...
@sb-mig/plugin-create-component/0.1.13 linux-x64 node-v12.20.0
$ sb-mig --help [COMMAND]
USAGE
  $ sb-mig COMMAND
...
...
_See code: [src/commands/create.ts](https://github.com/sb-mig/sb-mig/blob/v0.1.13/src/commands/create.ts)_
<!-- commandsstop -->
