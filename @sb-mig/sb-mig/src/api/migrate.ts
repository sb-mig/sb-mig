...
export const syncComponents = async (specifiedComponents: string[], ext: string | boolean, presets: boolean, packageName: boolean, local?: boolean) => {
  if (packageName) {
...
export const syncAllComponents = (ext: string | boolean, presets: boolean) => {
